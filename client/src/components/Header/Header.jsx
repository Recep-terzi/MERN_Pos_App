  ...
  return (
    <div className="border-b mb-6 w-[1440px] max-w-[96%] ml-auto mr-auto">
      <header className="py-4 px-6 flex justify-between items-center gap-10">
        ...
        <div className="menu-links flex justify-between items-center gap-7 md:static fixed bottom-0 md:w-auto w-screen bg-white md:bg-transparent left-0 md:border-t-0 border-t md:px-0 px-10 py-1">
          <a
            href="/"
